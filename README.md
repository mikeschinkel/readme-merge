...
![Tree for sample markdown source files](readme/assets/samples-source-tree.png)
...
![Tree for repo's actual markdown source files](readme/assets/actual-source-tree.png)
...
For more details about the entry-point file and document syntax see [Layout and Syntax](readme/layout-syntax.md).
...
![In your repo's Settings select GitHub Actions > General, select the Read and write permissions radio button in the Workflow Permissions section, and click the Save button.](readme/assets/read-write-access-setting.png)
...
![Samples directory tree](readme/assets/samples-source-tree.png)
_Directory tree for sample Markdown source files._
